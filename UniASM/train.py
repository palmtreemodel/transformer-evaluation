...
TRAIN_SIZE = 269960 # items in train dataset
TRAIN_FILENAMES = tf.io.gfile.glob(TRAIN_DATA + "train-269960.tfrec")
VAL_SIZE = 29994 # items in validate dataset
VAL_FILENAMES = tf.io.gfile.glob(TRAIN_DATA + "validate-29994.tfrec")
...
# train params
EPOCHS = 3
BATCH_SIZE = 2 * num_replicas_in_sync
print(BATCH_SIZE)
