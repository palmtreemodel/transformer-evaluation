...
An example is provided in ./command/test/get_value.py
download the pretrained model [here](https://drive.google.com/file/d/1qvg72YBDSCQf3p2AZMTXPwHrGk52XW-N/view?usp=share_link) and put it in checkpoints/pretrain
