...
class RobertaHubInterface(nn.Module):
    ...
    def encode2(self, sentence: dict) -> torch.LongTensor:
        """
        ...
        assert len(sentence_fields) == len(params.fields)
        ...
        # for field in params.byte_fields:
        #     output = torch.ones_like(token_dict[params.static_field], dtype=torch.float16)
    ...
    def process_token_dict(self, tokens: dict):
        ...
        assert len(token_fields) == len(params.fields)
        ...
        for field in params.fields:
            ...
            if field in params.non_byte_fields:
